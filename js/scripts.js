const Clickbutton = document.querySelectorAll(".button") //permite obtener de una clase de boton o id
...
function addToCarritoItem(e){
   ...
   <td class="table_price"><p>${item.precio}</p></td>
    ...
    <button class="delate btn btn-danger">X</button> 
    </td>
    `
    ...
    tr.querySelector(".delate").addEventListener("click", removeItemCarrito)
    ...
    function CarritoTotal(){
     ...
     function removeItemCarrito(e){
      const buttonDelate = e.target
      const tr = buttonDelate.closest(".ItemCarrito")
